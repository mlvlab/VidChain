...
GENERATED = [
    ...
    # f"{file_path}/THIS_FINAL_CAPFIRST_T2_1_conv_dpo_t2.json",  #Caption 2
    # f"{file_path}/THIS_FINAL_TIMEFIRST_T2_1_conv_dpo_t2.json", # Timestamp 3
    
#    f"{file_path}/THIS_FINAL_CAPFIRST_2_conv_dpo.json", # Timestamp 0  
    f"{file_path}/THIS_FINAL_TIMEFIRST_2_conv_dpo.json", # Caption 1 
    
    # f"{file_path}/THIS_FINAL_CAPFIRST_3_conv_dpo.json", # Timestamp 4
    f"{file_path}/THIS_FINAL_TIMEFIRST_3_conv_dpo.json" # Caption 5
]

GT_CONDITIONED = [ 
    # f"{file_path}/THIS_FINAL_T2_CAPFIRST_2_conv_dpo_t2.json",  #caption 0
    # f"{file_path}/THIS_FINAL_T2_TIMEFIRST_2_conv_dpo_t2.json", # Timestamp 1
    
    f"{file_path}/THIS_FINAL_CAPFIRST_4_conv_dpo.json", # Timestamp 2
    # f"{file_path}/THIS_FINAL_TIMEFIRST_4_conv_dpo.json", # Caption 3
    
    f"{file_path}/THIS_FINAL_CAPFIRST_5_conv_dpo.json", # Timestamp 4
    # f"{file_path}/THIS_FINAL_TIMEFIRST_5_conv_dpo.json", # Caption 5
]
...
with open( f'/home/jisoo/AAAI2025/VideoLLaMA2/outputs/ALL/final-GT-CONDITIONED-CAPFIRST.json', 'w') as f: f.write(json.dumps(final_dict, indent=2))
