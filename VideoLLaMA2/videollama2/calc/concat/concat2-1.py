...
file_path = "/home/jisoo/AAAI2025/VideoLLaMA2/outputs/final"
...
GENERATED = [
   f"{file_path}/THIS_FINAL_CAPFIRST_2_conv_dpo_gt_wo_gt.json", # Timestamp 0  
    ...
    f"{file_path}/THIS_FINAL_CAPFIRST_T2_1_conv_dpo_with_gt_2_t2.json",  #Caption 2
    f"{file_path}/THIS_FINAL_TIMEFIRST_T2_1_conv_dpo_with_gt_2_t2.json", # Timestamp 3
...
# T2 First
final_dict = {k:data_c[3][k]+data_c[2][k]+data_g[0][k]+data_g[1][k]+data_c[0][k]+data_c[1][k]+data_c[4][k]+data_c[5][k]+data_g[2][k]+data_g[3][k]+data_g[4][k]+data_g[5][k] for k in ['prompt', 'chosen', 'rejected', 'vid', 'logits']}
...
with open( f'/home/jisoo/AAAI2025/VideoLLaMA2/outputs/final/JOINT-FINAL-CAP2TIME-T2-NEW.json', 'w') as f: f.write(json.dumps(final_dict, indent=2))
