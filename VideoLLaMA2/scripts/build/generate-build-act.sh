...
# VARIABLES
GENERATED_SAMPLES_PATH=./outputs/mdpo-dataset/videollama2/generated-samples-act/
...
python videollama2/calc/eval_video_dvc.py \
    ...
    --mode 'dvc-capfirst' --num_samples 3
...
python videollama2/calc/eval_video_dvc.py \
    ...
    --mode 'dvc-timefirst' --num_samples 3
...
python videollama2/calc/eval_video_dvc.py \
    ...
    --output-file $GENERATED_SAMPLES_PATH \
    --save-file capfirst_score \
    --mode 'dvc-capfirst' --num_samples 3 --task2
...
python videollama2/calc/eval_video_dvc.py \
    ...
    --output-file $GENERATED_SAMPLES_PATH \
    --save-file timefirst_score \
    --mode 'dvc-timefirst' --num_samples 3 --task2
