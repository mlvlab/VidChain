...
# PATHS
OUTPUT_PATH=./outputs/
DPO_DATA_PATH=./data/activitynet/dpo-videollama2/mdpo-train.json
STAGE4=$OUTPUT_PATH/finetune_videollama2_activitynet-lora-stage4


RUN_NAME=finetune_videollama2_activitynet-lora-stage5
