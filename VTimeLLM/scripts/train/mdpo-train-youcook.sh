...
OUTPUT_DIR=./outputs/
STAGE4=./outputs/vtimellm-vicuna-v1-5-7b-youcook2-stage4


RUN_NAME=vtimellm-vicuna-v1-5-7b-youcook2-stage5
deepspeed --include localhost:$RANK --master_port $MASTER_PORT vtimellm/train/train_dpo_mem.py \
  ...
  --version v1 \
  --data_path ./data/YouCook2/dpo-vtimellm/mdpo-train.json \
  --data_folder ./data/YouCook2/ \
  --feat_folder ./data/YouCook2/clipvitl14-vtimellm.pth \
